...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <style type="text/css" class="bodyUsuarios">
        body {
            background-image: url('/app/Images/backgrounds/MB20.jpg');
            background-repeat: no-repeat;
            background-size: cover;
        }
    </style>
    <h2>Parqueos y Bahías</h2>
    <div>
    ...
    <asp:DropDownList ID="DropDownList1" runat="server" CssClass="busquedatxt" DataSourceID="SqlDataSource1" DataTextField="descripcion" DataValueField="descripcion" Visible="False" AutoPostBack="true" OnSelectedIndexChanged="onIndexChanged">
    ...
    <div>
        <asp:Table ID="bahiasMercedez" CssClass="table" runat="server" Visible="False">
            ...
            <asp:TableRow CssClass="tableRow">
                <asp:TableCell CssClass="tableCell">
                    <asp:ImageButton CssClass="botonFull" ID="btn_001" AlternateText="Grua" runat="server" ImageUrl="~/app/Images/icons/iconGrua.png" OnClientClick="window.showModalDialog('http://localhost:1874/app/ppAsignacion_Parqueos.aspx?field1=btn_001','Search','width=1025,height=410,left=150,top=200,scrollbars=1,toolbar=no,status=1')" />
                </asp:TableCell>
                <asp:TableCell CssClass="tableCell">
