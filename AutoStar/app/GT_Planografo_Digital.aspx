    ...
    <div>
        <asp:Table CssClass="table" ID="Table1" runat="server">
            <asp:TableRow CssClass="tableRow">
                ...
                <asp:TableCell CssClass="tableCell">
                    <asp:ImageButton CssClass="botonFull" ID="ImageButton1" AlternateText="Crear" runat="server" ImageUrl="~/app/Images/icons/iconCrear.png" OnClick="ImageButton1_Click" />  <%-- OnClientClick="window.showModalDialog('http://localhost:1874/app/ppCrearPlanografo.aspx','Search','width=1025,height=700,left=150,top=200,scrollbars=1,toolbar=no,status=1')"--%>
                </asp:TableCell>
...
<%--        <div id="Div16" runat="server" style="display: inline-block">
        ...
        <script>
            ...
            function llamar_ventana_Tecnicos() {
                window.showModalDialog('http://localhost:1874/app/ppEsperaPlanografo.aspx', 'Search', 'width=1025,height=700,left=150,top=200,scrollbars=1,toolbar=no,status=1');
            }
        </script>
    </div>
</asp:Content>
