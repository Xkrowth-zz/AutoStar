        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="Contraseña" SortExpression="password">
                <EditItemTemplate>
                    ...
                    <asp:RequiredFieldValidator ID="rfv_password" runat="server" ErrorMessage="Password es un campo obligatario" ControlToValidate="txtfld_contraseña" Text="*" ForeColor="Red"></asp:RequiredFieldValidator>
                </EditItemTemplate>
                <ItemTemplate>
