...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Panel ID="panel_login" runat="server">
        <asp:Label ID="label_usuario" runat="server" CssClass="busquedalbl" Text="Usuario: "></asp:Label>
        <asp:TextBox ID="usuario" runat="server"></asp:TextBox>
        <asp:Label ID="label_contraseña" runat="server" CssClass="busquedalbl" Text="Contraseña: "></asp:Label>        
