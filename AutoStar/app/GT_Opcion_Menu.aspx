    ...
    <div>
        <asp:Table CssClass="table" ID="Table1" runat="server">
            <asp:TableRow CssClass="tableRow">
                ...
                <asp:TableCell CssClass="tableCell">
                    <asp:ImageButton CssClass="botonFull" ID="ImageButton1" AlternateText="Crear" runat="server" ImageUrl="~/app/Images/icons/iconCrear.png" ValidationGroup="Insert" OnClientClick="alert_meth()" />
                </asp:TableCell>
                <asp:TableCell CssClass="tableCell">
                    <asp:ImageButton CssClass="botonFull" ID="ImageButton2" AlternateText="Editar" runat="server" ImageUrl="~/app/Images/icons/iconEditar.png" OnClientClick="alert_meth()" />
                </asp:TableCell>
                <asp:TableCell CssClass="tableCell">
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="descripcion" SortExpression="descripcion">
                ...
                <FooterTemplate>
                    ...
                    <asp:RequiredFieldValidator ID="rfv_opcion" ValidationGroup="Insert" runat="server" ErrorMessage="Opcion es un campo obligatario" ControlToValidate="TextBox3" Text="*" ForeColor="Red"></asp:RequiredFieldValidator>
                </FooterTemplate>
            </asp:TemplateField>
